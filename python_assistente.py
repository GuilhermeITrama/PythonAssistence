...
CUSTOM_PROMPT = """
Você é o "PYTHON Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.markdown("👨‍💻 Guilherme Irving Trama")

    # Link para conectar com o LinkedIn e GitHub do desenvolvedor
    st.markdown("🔗 [LinkedIn](https://www.linkedin.com/in/guilhermetrama/)")
    st.markdown("🔗 [GitHub](https://github.com/GuilhermeITrama/)")
    
    # Botão de link para enviar e-mail ao suporte.
    st.link_button("✉️ E-mail Para o Suporte no Caso de Dúvidas", "mailto:guilherme.trama@gmail.com")
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Analisando sua pergunta..."):
            ...
            try:
                ...
                python_ai_resposta = chat_completion.choices[0].message.content
                
                # Exibe a resposta no Streamlit
                st.markdown(python_ai_resposta)
                
                # Armazena resposta do assistente no estado da sessão
                st.session_state.messages.append({"role": "assistant", "content": python_ai_resposta})
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>PYTHON AI Coder - Trama Solutions IT</p>
    </div>
    """,
